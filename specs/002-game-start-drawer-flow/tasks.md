...
- [X] T007 [US2] Show drawer indicator in `frontend/src/pages/GamePage.tsx` — display the drawer's name prominently and show "You are the drawer" badge for the drawer vs "Drawer: [name]" for guessers
